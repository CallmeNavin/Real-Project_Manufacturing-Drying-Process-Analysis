...
- No direct output indicator: There was no sensor directly indicating drying time, drying weight for puffy outcome
...
- The approach consisted of 4 main steps:
  + Define drying episodes: Since no real-time drying classification existed, QC drying outcomes & machine operational logic were used to approximate drying periods. Puffy drying time were used by QC sample collecting time
...
- Process understanding is base. Tooling is amplifier.
